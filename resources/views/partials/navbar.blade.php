    ...
    <div class="col">
        ...
        <div class="main_nav_content d-flex flex-row">
            ...
            <div class="cat_menu_container">
                ...
                <ul class="cat_menu">
                    <li><a href="#">Tiket Atraksi<i class="fas fa-chevron-right"></i></a></li>
                    <li class="hassubs">
                        <a href="#">Paket Tour<i class="fas fa-chevron-right"></i></a>
                        <ul>
                            <li><a href="#">Dalam Negri<i class="fas fa-chevron-right"></i></a></li>
                            <li><a href="#">Luar Negri<i class="fas fa-chevron-right"></i></a></li>
                        </ul>
                    </li>
                    <li class="hassubs">
                        <a href="#">Paket Open Trip<i class="fas fa-chevron-right"></i></a>
                        <ul>
                            <li><a href="#">Dalam Negri<i class="fas fa-chevron-right"></i></a></li>
                            <li><a href="#">Luar Negri<i class="fas fa-chevron-right"></i></a></li>
                        </ul>
                    </li>
                    <li><a href="#">Booking Hotel<i class="fas fa-chevron-right"></i></a></li>
                </ul>
            </div>
            ...
            <div class="menu_trigger_container ml-auto">
                <div class="menu_trigger d-flex flex-row align-items-center justify-content-end">
                    <div class="menu_burger">
                        <div class="menu_trigger_text">News</div>
